    ...
    try:
        ...
        for comment in subreddit.stream.comments(skip_existing=True):
            ...
            if comment.author.name in Blocked_users and Enable_Blocking:
                ...
                print("u/\033[36m" + comment.author.name + " blocked temporarily for " + str(
                    time.gmtime() - block_time[temp_blocked.index(comment.author.name)]) + " seconds\033[0m")
            ...
            if parent(
                    comment).author.name == username and comment.body.lower() == "bad bot":  # check if the comment was a reply to the bot
                ...
                continue
                    ...
                    comment).author.name == username and comment.body.lower() == "good bot":  # check if the comment was a reply to the bot
